...
export const metadata: Metadata = {
    ...
    // Use same-origin manifest for install to avoid cross-deploy caching/staleness.
    // Versioned query param forces the browser to re-fetch after deployments.
    manifest: "/manifest.json?v=20260316-3",
    appleWebApp: {
        capable: true,
