...
// /admin/keepplay-engine/withdrawals/pending → shows Pending tab, "All" method filter
export default async function WithdrawalsPendingPage() {
    ...
    return (
        ...
        >
            <WithdrawalsClient initialTab="requests" initialMethod="all" />
        </AdminPageShell>
    );
}
