...
import KpeiUserDetailClient from "@/components/admin/kpei/KpeiUserDetailClient";

export default async function KpeUserDetailPage({
    params,
}: {
    ...
    return (
        ...
        >
            <KpeiUserDetailClient userId={id} />
        </AdminPageShell>
    );
}
