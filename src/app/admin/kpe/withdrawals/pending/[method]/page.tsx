...
export default async function KpeWithdrawalsPendingMethodPage({ params }: Props) {
    const { method } = await params;

    if (!VALID_METHODS.includes(method)) {
        redirect("/admin/kpe/withdrawals/pending");
    }
    ...
    return (
        ...
        >
            <KpeiWithdrawalsClient initialTab="requests" initialMethod={method} />
        </AdminPageShell>
    );
}
