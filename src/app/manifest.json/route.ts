...
export async function GET(request: NextRequest) {
    ...
    const manifest = {
        ...
        icons: [
            {
                src: isAdmin ? "https://public-pwa.vercel.app/admin-icon-192-20260316-8.png" : "/keepplay-logo2.png",
                sizes: "192x192",
                type: "image/png",
                purpose: "maskable any"
            },
            {
                src: isAdmin ? "https://public-pwa.vercel.app/admin-icon-512-20260316-8.png" : "/keepplay-logo2.png",
                sizes: "512x512",
                type: "image/png",
                purpose: "maskable any"
            },
        ...
        shortcuts: isAdmin ? [] : [
            {
                ...
                icons: [
                    {
                        src: "https://public-pwa.vercel.app/admin-icon-512-20260316-8.png",
                        sizes: "512x512"
                    }
                ]
            }
