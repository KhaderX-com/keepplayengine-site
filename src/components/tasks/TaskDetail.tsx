...
export default function TaskDetail({
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            {/* Slide-over Panel */}
            <div className="fixed inset-y-0 right-0 flex w-full sm:max-w-md md:max-w-lg">
                        ...
                        {loading ? (
                            ...
                            <>
                                ...
                                <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1 min-w-0 pr-2 sm:pr-4">
                                            ...
                                            <div className="flex items-center gap-1.5 sm:gap-2 mb-2 flex-wrap">
                                                <span className={`inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-medium
                                                    ...
                                                    <span className="hidden sm:inline">{STATUS_CONFIG[task.status].label}</span>
                                                </span>
                                        ...
                                        <button
                                            ...
                                            className="p-1.5 sm:p-2 rounded-lg text-gray-400 hover:text-gray-600 
                                                hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors shrink-0 touch-manipulation active:scale-95"
                                        >
                                    ...
                                    <div className="flex items-center gap-2 mt-3 sm:mt-4">
                                        <button
                                            onClick={() => onEdit(task)}
                                            className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/20 
                                                text-blue-600 dark:text-blue-400 font-medium text-xs sm:text-sm
                                                hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors touch-manipulation active:scale-95"
                                        >
                                            Edit
                                        </button>
                                        <select
                                            ...
                                            className="flex-1 px-2 sm:px-4 py-2 sm:py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 
                                                bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-xs sm:text-sm font-medium
                                ...
                                <div className="flex-1 overflow-y-auto">
                                    ...
                                    {task.description && (
                                        <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700">
                                            <h3 className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Description</h3>
                                            <p className="text-sm sm:text-base text-gray-900 dark:text-white whitespace-pre-wrap">{task.description}</p>
                                        </div>
                                    )}
                                            ...
                                            <div>
                                                {task.subtasks && task.subtasks.length > 0 ? (
                                                    ...
                                                    <div className="text-center py-12">
                                                        ...
                                                        <p className="text-sm font-medium text-gray-900 dark:text-white mb-2">No subtasks yet</p>
